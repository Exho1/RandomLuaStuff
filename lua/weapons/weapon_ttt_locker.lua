...
if CLIENT then
   ...
   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = [[Allows you to lock a door for
        a short period of time! People can also
        shoot your doors down!! ]]
   };
end
...
if SERVER then
        ...
        function DoorTakeDamage( prop, dmginfo )
                if ( DCheck( prop ) and prop:GetNWBool("TTTLocked") ) then
